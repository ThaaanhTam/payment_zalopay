    ...
    def _get_specific_rendering_values(self, processing_values):
       ...
       # Lấy các mục từ đơn hàng
        ...
        order = {
            ...
            "bank_code": "",
            "callback_url": urls.url_join(base_url.replace('http://', 'https://'), '/payment/zalopay/callback'),  # URL callback
        }
        _logger.info("url callbackkkkkk")
        _logger.info(urls.url_join(base_url.replace('http://', 'https://'), '/payment/zalopay/callback'))
